...
import { emptyScreeningForm } from "../types/health";

const screeningOptions = {
  gender: ["Female", "Male", "Non-binary"],
  smoking: ["No", "Occasionally", "Daily"],
  alcohol: ["Never", "Occasionally", "Weekly"],
  exercise: ["1x per week", "3x per week", "Daily"],
...
export function ScreeningPage() {
  ...
  const updateField = (key: keyof typeof emptyScreeningForm, value: string) => {
          ...
          <div className="field-row">
            ...
            <label>
              ...
              <select
                ...
                {screeningOptions.gender.map((option) => (
          ...
          <div className="field-row">
            <label>
              ...
              <select
                value={form.smoking}
                onChange={(event) =>
                  updateField("smoking", event.target.value)
                }>
                {screeningOptions.smoking.map((option) => (
                  <option key={option}>{option}</option>
                ))}
              </select>
            </label>
            <label>
              ...
              <select
                value={form.alcohol}
                onChange={(event) =>
                  updateField("alcohol", event.target.value)
                }>
                {screeningOptions.alcohol.map((option) => (
                  <option key={option}>{option}</option>
                ))}
              </select>
            </label>
          ...
          <div className="field-row">
            <label>
              ...
              <select
                ...
                {screeningOptions.exercise.map((option) => (
                  <option key={option}>{option}</option>
                ))}
              </select>
            </label>
            <label>
              ...
              <select
                ...
                {screeningOptions.diet.map((option) => (
                  <option key={option}>{option}</option>
                ))}
              </select>
            </label>
            ...
            {screeningChecks.medical.map(([key, label]) => (
              <label key={key} className="check-item">
                <input
                  type="checkbox"
                  checked={
                    form[key as keyof typeof emptyScreeningForm] === "Yes" ||
                    form[key as keyof typeof emptyScreeningForm] === "No"
                      ? form[key as keyof typeof emptyScreeningForm] === "Yes"
                      : false
                  }
                  onChange={() =>
                    updateField(
                      key as keyof typeof emptyScreeningForm,
                      form[key as keyof typeof emptyScreeningForm] === "Yes"
                        ? "No"
                        : "Yes",
                    )
            ...
            {screeningChecks.symptoms.map(([key, label]) => (
              <label key={key} className="check-item">
                <input
                  ...
                  checked={
                    form[key as keyof typeof emptyScreeningForm] === "Yes" ||
                    form[key as keyof typeof emptyScreeningForm] === "Sometimes"
                      ? true
                      : false
                  }
                  onChange={() =>
                    updateField(
                      key as keyof typeof emptyScreeningForm,
                      form[key as keyof typeof emptyScreeningForm] === "Yes" ||
                        form[key as keyof typeof emptyScreeningForm] ===
                          "Sometimes"
                        ? "No"
                        : "Yes",
                    )
          ...
          <div className="field-row">
            <label>
              ...
              <select
                ...
                onChange={(event) =>
                  updateField("familyDiabetes", event.target.value)
                }>
                {screeningOptions.yesNo.map((option) => (
                  <option key={option}>{option}</option>
                ))}
              </select>
            </label>
            <label>
              ...
              <select
                ...
                onChange={(event) =>
                  updateField("familyCardio", event.target.value)
                }>
                {screeningOptions.yesNo.map((option) => (
                  <option key={option}>{option}</option>
                ))}
            ...
            <label>
              ...
              <select
                ...
                onChange={(event) =>
                  updateField("familyCancer", event.target.value)
                }>
                {screeningOptions.yesNo.map((option) => (
                  <option key={option}>{option}</option>
                ))}
